...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('D:\TSR\program1\German-Traffic-Sign-Recognition-with-Deep-Learning-master\Outputs1/accuracy1.png')
plt.show()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('D:\TSR\program1\German-Traffic-Sign-Recognition-with-Deep-Learning-master\Outputs1/loss1.png')
plt.show()
time_end=time.time()
time_user=time_start-time_end
print(time_user)
...
torch.save({
            ...
            'loss': criterion,
            }, 'D:\TSR\program1\German-Traffic-Sign-Recognition-with-Deep-Learning-master\Outputs1/model1.pth')